...
you should place your code here."
  ...
  ;; TODO auto-mount /Private if not present
...
;;   (setq mu4e-sent-folder "~/email/sent"
;;         mu4e-drafts-folder "~/email/drafts"
;;         user-mail-address "nikatwork@gmail.com"
...
;;         smtpmail-smtp-service 465)
  ...
  ;;-- TODO this is only disabled while we're learning spacemacs
  (setq dotspacemacs-mode-line-unicode-symbols nil) ;; don't use fancy mode icons
  (spacemacs/toggle-mode-line-minor-modes-off) ;; don't show minor mode info

  ;;-- FIXME setup mouse mode - copy/paste etc. disable for now. TODO only in terminal.
  (global-disable-mouse-mode)
  (xterm-mouse-mode -1)
;;  (gpm-mouse-mode nil)

  ;;-- package config
  (setq-default evil-escape-key-sequence "jk") ;; use jk to exit Insert mode (type j then k slowly to type the actual string "jk") 
  (setq powerline-default-separator 'arrow) ;; don't use fancy powerline symbols that would need a patched font
  (setq browse-url-browser-function 'eww-browse-url) ;; use eww package as web browser
  ...
  ;; erc-server-list
  ;; `(
  ;;   ("irc.gitter.im" :port "6667" :nick "TheBB" :full-name ,bb/full-name :ssl t :password ,bb/gitter-pwd)
